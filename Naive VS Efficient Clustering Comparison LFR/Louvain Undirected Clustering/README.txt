...
Note that the program is expecting a friendly use and 
...
communities on graphs weighted or unweighted.
...
2. 
Computes communities with a specified quality function and displays hierarchical tree:
...
modularity is 
below epsilon for a given iteration or pass:
...
4. 
To display the X relational matrix for a given level of the tree:
